        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleCategories_VehicleTypes_VehicleTypeId",
                        column: x => x.VehicleTypeId,
                        principalTable: "VehicleTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleFeatures_VehicleTypes_VehicleTypeId",
                        column: x => x.VehicleTypeId,
                        principalTable: "VehicleTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAgencyOwned = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    TypeSpecificData = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Documents_Vehicles_EntityId",
                        column: x => x.EntityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HostGoals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HostGoals_AspNetUsers_HostId",
                        column: x => x.HostId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HostGoals_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_Vehicles_RelatedVehicleId",
                        column: x => x.RelatedVehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleBlockedDates", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleBlockedDates_AspNetUsers_BlockedBy",
                        column: x => x.BlockedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_VehicleBlockedDates_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleFeatureMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleFeatureMappings_VehicleFeatures_VehicleFeatureId",
                        column: x => x.VehicleFeatureId,
                        principalTable: "VehicleFeatures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleFeatureMappings_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleHistories_AspNetUsers_ChangedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleLocations_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HostGoals_HostId",
                table: "HostGoals",
                column: "HostId");

            migrationBuilder.CreateIndex(
                name: "IX_HostGoals_VehicleId",
                table: "HostGoals",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_RelatedVehicleId",
                table: "Messages",
                column: "RelatedVehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleBlockedDates_BlockedBy",
                table: "VehicleBlockedDates",
                column: "BlockedBy");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleBlockedDates_VehicleId",
                table: "VehicleBlockedDates",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleCategories_VehicleTypeId",
                table: "VehicleCategories",
                column: "VehicleTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleFeatureMappings_VehicleFeatureId",
                table: "VehicleFeatureMappings",
                column: "VehicleFeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleFeatureMappings_VehicleId",
                table: "VehicleFeatureMappings",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleFeatures_VehicleTypeId",
                table: "VehicleFeatures",
                column: "VehicleTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleHistories_ChangedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleLocations_CityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleMedias_VehicleId",
                table: "VehicleMedias",
                column: "VehicleId");
